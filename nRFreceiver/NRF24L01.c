...
/**
 *  \brief     uint16_t *nRF24L01_WriteRead (uint16_t , uint16_t , uint16_t *, uint16_t )
 ...
 *  @param     uint16_t *val 	  -	Modo escritura, esta variable contiene los elementos a escribir
 ...
 *
 *  				- nRF24L01+ Modo RECEPTOR, POWER UP ( nRF24L01+ estado Standby-I ).
 *
...
void nRF24L01_init ( void )
{
	...
	// El dispositivo nRF24L01+ se encuentra configurado y esperando a recibir paquetes.
}



/**
 *  \brief     uint16_t nRF24L01_send ( uint8_t * )
 ...
 *
 *  				- 0x00:	Transmisión correcta.
 *  				- 0xFF:	Transmisión fallida.
 *
 *  \author    Manuel Caballero
 *  \version   0.0
 *  \date      11/2/2015
