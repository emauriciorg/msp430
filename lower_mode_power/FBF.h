...
void Adc(){
	...
	ADC10AE0 = 0x0003;                        //P1.5 ADC option�
}
...
void interrupcion()
{
	...
	P1REN=BIT3;
	P1IES=BIT3; // INTERRUPT EDGE SELECT  EDGE SELECTS THE INTERRUPT EDGE FOR THE CORRESPONDIN I/O, 0 MEANS low-to-high transition, 1 means a high-to-low transition
    P1OUT=BIT3;
